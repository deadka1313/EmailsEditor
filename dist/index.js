...
var FormDom = /** @class */ (function() {
  function FormDom(elem) {
    ...
    this.wrapperForm.addEventListener("click", function(e) {
      return _this.setFocusInput(e);
    });
...
var CreateEmailForm = /** @class */ (function() {
  ...
  function CreateEmailForm(element, callback) {
    ...
    this.addEmail = function(email) {
      ...
      var inputEmailsSplit = inputEmails.split(/\s|,/).filter(function(item) {
        return item;
      });
      ...
      newEmails.map(function(item) {
        if (!checkForRepeatedEmails(item.name, _this.emails)) {
          ...
          itemDOM === null || itemDOM === void 0
            ? void 0
            : itemDOM.addEventListener("click", function(e) {
                return _this.removeEmail(e);
              });
        }
      });
      _this.callCallback();
    ...
    this.removeEmail = function(e) {
      if (e) {
        ...
        _this.emails = _this.emails.filter(function(item) {
    ...
    if (this.formDom.inputElement) {
      ...
      this.formDom.inputElement.addEventListener(inputEventType, function(e) {
        return _this.onChange(e);
      });
      this.formDom.inputElement.addEventListener("blur", function(e) {
